...
my $PChar='[{(\µ\`"½®\202\204\206\207\213\221\222\223\224\225\226\227\233';
...
if (defined($opt_f)) {
  ...
  $FClitic = '-t-elles?|-t-ils?|-t-on|-ce|-elles?|-ils?|-je|-la|-les?|-leur|-lui|-mˆmes?|-m\'|-moi|-nous|-on|-toi|-tu|-t\'|-vous|-en|-y|-ci|-l…';
}
...
for( $i=0; $i<=$#S; $i++) {
  ...
  if (/^<.*>$/) {
	...
	next;
      ...
      if (/^([A-Za-zÀÁÂÃÄÈÉÊËÌÍÎÏÒÓÔÕÖÙÚÛÜàáâãäçèéêëìíîïòóôõöùúûü]\.)+$/) {
	print "$_\n$suffix";
	next;
      }
