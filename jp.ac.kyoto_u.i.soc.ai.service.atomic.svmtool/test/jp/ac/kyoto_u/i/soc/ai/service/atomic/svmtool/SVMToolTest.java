...
public class SVMToolTest {
	
	@Test
	public void testNormal1() throws Exception {
		String sentence = "This is test sentence.";
		SVMTool svm = new SVMTool();
		svm.setPath("/usr/local/SVMTool-1.3.1");
		Morpheme[] morphemes = svm.analyze("es", sentence);
	...
	public void test2() throws Exception {
		...
		SVMTool svm = new SVMTool();
		svm.setPath("/usr/local/SVMTool-1.3.1");
		Morpheme[] ret = svm.analyze("en", text);
		for (Morpheme m : ret) {
	...
	public void testSpanish() throws Exception {
		String sentence = "He vivido en U.S.A cuando yo era muy joven.";
		SVMTool svm = new SVMTool();
		svm.setPath("/usr/local/SVMTool-1.3.1");
		Morpheme[] morphemes = svm.analyze("es", sentence);
		for (Morpheme morpheme : morphemes) {
