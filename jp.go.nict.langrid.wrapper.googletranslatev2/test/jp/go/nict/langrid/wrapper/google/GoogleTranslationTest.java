/*
 * $Id: GoogleTranslationTest.java 28453 2011-05-24 08:51:11Z Takao Nakaguchi $
 *
...
*/
	...
	public void test_ja_en_multiStatement() throws Exception{
		System.out.println(Arrays.toString(service.doMultistatementTranslation(
				ja, en
				, new String[]{
						"Googleは、\nFCC (米連邦通信委員会) にWhite Spaces Databaseの\n管理者になることを提案した。\n"
						, "JavaFXには、2010年冬季オリンピックWebサイトなど、注目度の高い早期採用事例も出てきている。"
