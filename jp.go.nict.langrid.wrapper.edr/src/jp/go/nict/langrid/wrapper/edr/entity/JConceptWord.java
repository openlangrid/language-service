/*
 * $Id: JConceptWord.java 26411 2008-08-28 08:58:33Z nakaguchi $
 *
...
/**
 * 英語単語辞書、日本語単語辞書の情報から、概念辞書の実装に必要な情報のみを格納する。
 * @author $Author: nakaguchi $
 * @version $Revision: 26411 $
 */
@Entity
public class JConceptWord
implements ConceptWord
{
	...
	public String getHeadWordReading() {
		return headWordReading;
	}

	public void setHeadWordReading(String headWordReading) {
		this.headWordReading = headWordReading;
	}
	...
	public String getConceptHeadWordJapaneseReading() {
		return conceptHeadWordJapaneseReading;
	}

	public void setConceptHeadWordJapaneseReading(String conceptHeadWordJapaneseReading) {
		this.conceptHeadWordJapaneseReading = conceptHeadWordJapaneseReading;
	}

	public String getGloss(){
		return getConceptGlossJapanese();
	}
