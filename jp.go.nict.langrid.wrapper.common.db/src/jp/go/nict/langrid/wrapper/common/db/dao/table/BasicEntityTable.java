...
public class BasicEntityTable<T extends BasicEntity>
extends AbstractTable{
	...
	public void insert(
			Connection connection, long id, Language[] languages, String[] values)
	throws SQLException
	{
	...
	private static String insertEntity
			= "INSERT INTO \"%s\" (\"entityId\", %s) VALUES (?, %s)";
	private static String deleteEntity = "DELETE FROM \"%s\" WHERE \"entityId\"=?";
	private static String updateEntity
			= "UPDATE \"%s\" SET %s, \"updatedDateTime\"=CURRENT_TIMESTAMP WHERE \"entityId\"=?";
}
