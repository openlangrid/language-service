/*
 * $Id: ParallelTextServicePart.java 26847 2008-12-12 08:37:57Z Takao Nakaguchi $
 *
...
import jp.go.nict.langrid.wrapper.common.iniFileUtil.paralleltext.HTML_Resource;
 ...
 */
public class ParallelTextServicePart {
	 ...
	 * @throws IOException 
	 */
	public ParallelTextServicePart(HTML_Resource res) 
	 ...
	 * @param source 対訳を検索したい文字列
	 * @param matchingMethod 検索方法
	 * @return 検索結果
	 */
	public Collection<ParallelText> doSubSearch(Language sourceLang,
			Language targetLang, String source, MatchingMethod matchingMethod) {
		return LocalParallelTextService.doSearch(sourceLang, targetLang, source, matchingMethod,
				languages, texts);
	}
	 ...
	 */
	String getTextsAsCSV(Map<Language,Integer> langIndex, String splitter) {
	 ...
	 * SubServiceIntegraterで、重複を削った結合をするために使用する。
	 * 上のgetTextsAsCSVとこれの、どちらかを使用
	 * @param langIndex 言語コードの順序を保持
	 * @param splitter スプリッタとして使用する文字列
	 * @return 対訳ペアをスプリッタで区切ったもの
	 */
	ArrayList<String> getTextsAsCSVList(Map<Language,Integer> langIndex, String splitter){
