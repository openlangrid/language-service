/*
 * $Id: ParallelTextServicePartIntegrater.java 26847 2008-12-12 08:37:57Z Takao Nakaguchi $
 *
 ...
 */
public class ParallelTextServicePartIntegrater {

	// 各サブ資源へのリンク
	private ArrayList<ParallelTextServicePart> services;
	 ...
	 * @throws IOException 
	 */
	public ParallelTextServicePartIntegrater(HTML_ServiceDescription sd)
			throws ProcessFailedException, IOException {

		// フィールドの初期化
		services = new ArrayList<ParallelTextServicePart>();
		...
		for (int i = 0; i < sd.getResources().length; i++) {
			ParallelTextServicePart buff
			= new ParallelTextServicePart(sd.getResources()[i]);
