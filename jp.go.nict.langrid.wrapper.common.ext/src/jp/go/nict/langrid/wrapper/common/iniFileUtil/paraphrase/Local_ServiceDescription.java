 ...
 */
package jp.go.nict.langrid.wrapper.common.iniFileUtil.paraphrase;
...
public class Local_ServiceDescription extends ServiceDescription {
	 ...
	 */
	public Local_ServiceDescription(InputStream inputStream) throws ProcessFailedException {
		super(inputStream);
	}
